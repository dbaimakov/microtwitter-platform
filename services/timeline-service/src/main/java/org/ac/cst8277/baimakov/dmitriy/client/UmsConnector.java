...
public class UmsConnector {
    ...
    public AuthContextResponse validateToken(String token) {
        ...
        try {
            ...
            throw toResponseStatusException(ex, HttpStatus.UNAUTHORIZED, "US error");
        } catch (ResponseStatusException ex) {
            throw ex;
        } catch (Exception ex) {
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Failed to commnicate with UMS", ex);
        }
    }
